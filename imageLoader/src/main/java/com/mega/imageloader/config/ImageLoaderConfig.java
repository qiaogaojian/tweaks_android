package com.mega.imageloader.config;
...
import com.mega.imageloader.transform.CropTransformation;
...
public class ImageLoaderConfig {
    ...
    private Animator animator; //在异步加载资源完成时会执行该动画。可以接受一个Animator对象
    ...
    private boolean crop;//截图
    private int rotateDegree;//默认旋转°
    private String tag; //唯一标识
    private int cropWidth;//截图的宽
    private int cropHeight;//截图的高
    private String cropType;//0 截中间 1 上部 2 下部
    ...
    public static class Builder {
        ...
        public Builder isCrop(boolean crop){
            this.crop = crop;
            return this;
        }
