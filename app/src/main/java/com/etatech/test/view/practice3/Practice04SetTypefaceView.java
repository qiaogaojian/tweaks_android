...
public class Practice04SetTypefaceView extends View {
...

    {
        ...
        typeface = Typeface.createFromAsset(getContext().getAssets(), "fonts/source_code_pro.ttf");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/source_code_pro.ttf"));
