...
public class FloatMenuView extends View
{
    ...
    private void initView( ) {
        ...
        mAlphaAnim.addListener(new FloatMenuView.MyAnimListener() {
            @Override
    ...
    public static class Builder {
        ...
        public FloatMenuView.Builder drawNum(boolean drawNum) {
            mDrawNum = drawNum;
            return this;
        }
        ...
        public FloatMenuView.Builder setCicleBg(boolean cicleBg) {
            this.cicleBg = cicleBg;
            return this;
        }

        public FloatMenuView.Builder setStatus(int status) {
            mStatus = status;
            return this;
        }
        ...
        public FloatMenuView.Builder setBackgroundColor(int color) {
            mBgColor = color;
            return this;
        }
