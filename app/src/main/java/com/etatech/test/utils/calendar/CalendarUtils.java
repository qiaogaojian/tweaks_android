package com.etatech.test.utils.calendar;
...
public class CalendarUtils {
     ...
     * Calender Event Use
     */
    public static String SELECTION_CRITERIA = "calendar_id = ? and deleted == 0";
    public static ArrayList<Long> calendar_id = new ArrayList<Long>();//行事曆ID(種類)
    ...
    public static ArrayList<String> readCalendarEvent(Context context) {
        ...
        event_id.clear();
        for (int i = 0; i < CNames.length; i++) {
            calendar_id.add(Long.parseLong(cursor.getString(0)));//1:google 2:google plus 3:系統 4:本機
    ...
    public static void deleteAllEvent(Context context) {
        ...
        for (int i = 0; i < nameOfEvent.size(); i++) {
            String[] args = new String[]{calendar_id.get(i) + ""};
            context.getContentResolver().delete(CALENDAR_URI, SELECTION_CRITERIA, args);
        }
    }
