...
public class GLRender3Rect extends MyGLRender {
    ...
    static float vertexs[] = {
            -0.8f,  0.8f/App.getInstance().designRatio, 0.0f,      // top left
            -0.8f, -0.8f/App.getInstance().designRatio, 0.0f,     // bottom left
             0.8f, -0.8f/App.getInstance().designRatio, 0.0f,      // bottom right
             0.8f,  0.8f/App.getInstance().designRatio, 0.0f};      // top right
